...
public class HellfireOrb extends AbstractOrb{
    ...
    public static String NAME = "Hellfire";
    public static final String ORB_ID = makeID(NAME);
    private static final OrbStrings orbString = CardCrawlGame.languagePack.getOrbString(ORB_ID);
    public static com.badlogic.gdx.graphics.Color color = Color.FIREBRICK.cpy();
    public static com.badlogic.gdx.graphics.Color color2 = Color.ORANGE.cpy();
