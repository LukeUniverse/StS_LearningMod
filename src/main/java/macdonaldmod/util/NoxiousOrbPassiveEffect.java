...
//most of this was copied from elsewhere, this is very WIP and *needs* more modification

public class NoxiousOrbPassiveEffect extends AbstractGameEffect {
    ...
    public NoxiousOrbPassiveEffect(float x, float y) {
        this.renderBehind = MathUtils.randomBoolean();
        this.x = x;
        this.y = y;
        this.color = Color.LIME.cpy();
